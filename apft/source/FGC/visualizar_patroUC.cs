...
namespace FGC
{
    public partial class visualizar_patroUC : UserControl
    {
        private SqlConnection CN;
        public visualizar_patroUC()
        {
            InitializeComponent();
        }
        ...
        private void ExibirDadosTabela()
        {
            ...
            if (temp)
            {
                try
                {
                    ...
                    string query = "SELECT * FROM FGC.Patrocinador";
                    ...
                    while (reader.Read())
                    {
                        dataGridView1.Rows.Add(reader["nif"], reader["telefone"], reader["nome"], reader["email"]);
                    }
