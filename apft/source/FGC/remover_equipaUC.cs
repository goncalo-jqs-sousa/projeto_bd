...
namespace FGC
{
    public partial class remover_equipaUC : UserControl
    {
        private SqlConnection CN;
        public remover_equipaUC()
        {
            InitializeComponent();
        }
            ...
            if (temp)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string queryRemoverEquipa = "DELETE FROM FGC.Equipa WHERE nif = @nif";
                        ...
                        MessageBox.Show("Equipa removida com sucesso!");
                    ...
                    {
                        MessageBox.Show("Ocorreu um erro ao remover a equipa: " + ex.Message);
                    }
                }
            }
