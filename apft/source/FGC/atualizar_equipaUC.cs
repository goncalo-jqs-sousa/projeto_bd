...
namespace FGC
{
    public partial class atualizar_equipaUC : UserControl
    {
        private SqlConnection CN;
        public atualizar_equipaUC()
        {
            InitializeComponent();
        }
            ...
            if (temp)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string queryInserirEquipa = "UPDATE FGC.Equipa SET nome = @nome, num_jogadores = @nj, num_torneios_ganhos = @ntg WHERE nif = @nif;";
                        ...
                        MessageBox.Show("Equipa atualizada com sucesso!");
                    ...
                    {
                        MessageBox.Show("Ocorreu um erro ao atualizar a equipa: " + ex.Message);
                    }
                }
            }
        ...
        private void Equipa_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryEquipas2 = "SELECT nif FROM FGC.Equipa";
