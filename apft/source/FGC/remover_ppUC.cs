...
namespace FGC
{
    public partial class remover_ppUC : UserControl
    {
            ...
            if (temp)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string queryRemoverEquipa = "DELETE FROM FGC.ProPlayer WHERE nif = @nif";
                        ...
                        MessageBox.Show("Pro player removido com sucesso!");
                    ...
                    {
                        MessageBox.Show("Ocorreu um erro ao remover o pro player: " + ex.Message);
                    }
                }
            }
        ...
        private void Equipa_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryEquipas = "SELECT nif FROM FGC.ProPlayer";
            ...
            {
                MessageBox.Show("Ocorreu um erro ao consultar os pro players: " + ex.Message);
            }
            finally
            {
