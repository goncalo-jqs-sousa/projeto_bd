...
namespace FGC
{
    public partial class remover_patroUC : UserControl
    {
        private SqlConnection CN;
        public remover_patroUC()
        {
            InitializeComponent();
        }
            ...
            if (temp)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string queryRemoverEquipa = "DELETE FROM FGC.Patrocinador WHERE nif = @nif";
                        ...
                        MessageBox.Show("Patrocinador removido com sucesso!");
                    ...
                    {
                        MessageBox.Show("Ocorreu um erro ao remover o patrocinador: " + ex.Message);
                    }
                }
            }
        ...
        private void Equipa_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryEquipas = "SELECT nif FROM FGC.Patrocinador";
