...
namespace FGC
{
    public partial class atualizar_patroUC : UserControl
    {
        private SqlConnection CN;
        public atualizar_patroUC()
        {
            InitializeComponent();
        }
            ...
            if (temp)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string queryInserirPatrocinador = "UPDATE FGC.Patrocinador SET telefone = @telefone, nome = @nome, email = @email WHERE nif = @nif;";
                        ...
                        MessageBox.Show("Patrocinador atualizado com sucesso!");
                    ...
                    {
                        MessageBox.Show("Ocorreu um erro ao atualizar o patrocinador: " + ex.Message);
                    }
                }
            }
        ...
        private void Equipa_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryEquipas2 = "SELECT nif FROM FGC.Patrocinador";
            ...
            {
                MessageBox.Show("Ocorreu um erro ao consultar os patrocinadores: " + ex.Message);
            }
            finally
            {
