...
namespace FGC
{
    public partial class atualizar_edUC : UserControl
    {
        private SqlConnection CN;
        public atualizar_edUC()
        {
            InitializeComponent();
        }
            ...
            if (temp)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string queryInserirEquipa = "UPDATE FGC.EquipaDesenvolvedores SET nome = @nome, num_desenvolvedores = @nd WHERE nif = @nif;";
                        ...
                        MessageBox.Show("Equipa de desevolvedores atualizada com sucesso!");
                    ...
                    {
                        MessageBox.Show("Ocorreu um erro ao atualizar a equipa de desevolvedores: " + ex.Message);
                    }
                }
            }
        ...
        private void Equipa_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryEquipas2 = "SELECT nif FROM FGC.EquipaDesenvolvedores";
