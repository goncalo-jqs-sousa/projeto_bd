...
namespace FGC
{
    public partial class remover_fgUC : UserControl
    {
            ...
            if (temp)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string queryRemoverEquipa = "DELETE FROM FGC.FightingGame WHERE nome = @nome";
                        ...
                        MessageBox.Show("Fighting game removido com sucesso!");
                    ...
                    {
                        MessageBox.Show("Ocorreu um erro ao remover o fighting game: " + ex.Message);
                    }
                }
            }
        ...
        private void Equipa_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryEquipas = "SELECT nome FROM FGC.FightingGame";
