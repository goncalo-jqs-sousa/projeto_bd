...
namespace FGC
{
    public partial class remover_edUC : UserControl
    {
            ...
            if (temp)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string queryRemoverEquipa = "DELETE FROM FGC.EquipaDesenvolvedores WHERE nif = @nif";
                        ...
                        MessageBox.Show("Equipa de desenvolvedores removida com sucesso!");
                    ...
                    {
                        MessageBox.Show("Ocorreu um erro ao remover a equipa de desenvolvedores: " + ex.Message);
                    }
                }
            }
